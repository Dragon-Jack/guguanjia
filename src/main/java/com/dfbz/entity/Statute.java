...
public class Statute {
    ...
    public Statute(Long id, Long areaId, Integer type, String title, Date pubDate, String code, String stemFrom, Date createDate, Date updateDate, String delFlag, String createBy, String description) {
        this.id = id;
        this.areaId = areaId;
        this.type = type;
        this.title = title;
